export const en = {
  ...
  printing: {
    ...
    itemsPurchased: 'ITEMS PURCHASED',
    generatedBy: 'Generated by Mini POS',
    // Bluetooth printing
  ...
  inventory: {
    ...
    categoryInventoryValue: '{{category}} Inventory Value',
  ...
  stockMovement: {
    ...
    // Filter modal
    filterTitle: 'Filter Movement History',
  ...
  categories: {
    ...
    addFirstCategory: 'Add your first category to organize products',
    categories: 'categories',
    category: 'category',
    categoryAdded: 'Category added successfully',
    categoryUpdated: 'Category updated successfully',
  ...
  expenses: {
    ...
    addFirstCategory: 'Add your first expense category to get started',
    addCategory: 'Add Category',
    editCategory: 'Edit Category',
    deleteCategory: 'Delete Category',
    deleteCategoryConfirmation: 'Are you sure you want to delete "{name}"?',
    categoryDeleted: 'Category deleted successfully!',
    categoryAdded: 'Category added successfully!',
    categoryUpdated: 'Category updated successfully!',
    ...
    failedToSaveCategory: 'Failed to save category',
    categoryName: 'Category Name',
    categoryNamePlaceholder: 'e.g., Rent, Utilities, Supplies',
  ...
  license: {
    ...
    accessAllFeatures:
      'To access all features of Mini POS, please verify your license using the steps below.',
    challengeCode: 'Challenge Code',
    googleAccount: 'Google Account',
    chooseVerificationMethod: 'Choose verification method',
    traditionalOfflineVerification: 'Traditional offline verification',
    quickSecureWithGoogle: 'Quick & secure with Google',
    licenseDuration: 'License Duration',
    selectDurationAndGenerate:
      'Select your license duration and generate challenge code',
    ...
    noInternetUseChallengeCode: 'No internet? Use challenge code instead',
    backToGoogleSignIn: 'Back to Google Sign In',
    viewPricing: 'View Pricing Plans',
    // License Management
    licenseOverview: 'License Overview',
    licenseActions: 'License Management Actions',
    support: 'Support & Contact',
    googleAccountExtension: 'Google Account Extension',
    challengeCodeExtension: 'Challenge Code Extension',
    viewPricingPlans: 'View Pricing Plans',
    comparePlansAndPricing: 'Compare plans and pricing options',
    contactForSupport: 'Contact us for license support and assistance',
  ...
  pricing: {
    ...
    subtitle:
      'Choose the perfect plan for your business needs. All plans include full POS features with local data storage.',
    monthly: 'Monthly',
    yearly: 'Yearly',
    lifetime: 'Lifetime',
    perMonth: 'per month',
    ...
    off: 'OFF',
    limitedTimeOffer: '🎉 Limited Time Offer - Up to 50% OFF!',
    discountUntil: 'Special pricing available until',
    fullPOSAccess: 'Full POS system access',
    inventoryManagement: 'Inventory management',
    salesReporting: 'Sales reporting & analytics',
    customerManagement: 'Customer management',
    dataExport: 'Data export & backup',
    multiLanguage: 'Multi-language support',
    prioritySupport: 'Priority customer support',
    freeUpdates: 'Free updates for 1 year',
    lifetimeUpdates: 'Lifetime free updates',
    noRecurringFees: 'No recurring fees',
    bestValue: 'Best value for money',
    readyToPurchase: 'Ready to Purchase?',
    contactUsToGetStarted:
      'Contact us via phone or Viber to get your license activated',
    callNow: 'Call Now',
    viberChat: 'Viber Chat',
    contactPhone: 'Contact Phone',
    whyChooseMiniPOS: 'Why Choose Mini POS?',
    easyToUse: 'Easy to Use',
    easyToUseDesc:
      'Intuitive interface designed for Myanmar businesses with local language support',
    completeFeatures: 'Complete Features',
    completeFeaturesDesc:
      'Everything you need: sales, inventory, reports, customer management, and more',
    localSupport: 'Local Support',
    localSupportDesc:
      'Get help in Myanmar language with local phone and Viber support',
    dataOwnership: 'Your Data, Your Control',
    dataOwnershipDesc:
      'All data stored locally on your device - no monthly cloud fees or data sharing',
  },
  help: {
    title: 'Help & Support',
    ...
    // Quick Start Guide
    quickStartTitle: 'Getting Started with Mini POS',
    ...
    performanceIssueSolution:
      'Close other apps and restart Mini POS. Clear app cache if problem persists.',
    // How to Use Sections
    ...
    tipsSubtitle: 'Pro tips to use Mini POS more efficiently',
    quickActions: '🚀 Quick Actions',
  ...
  about: {
    ...
    legal: 'Legal',
    copyright: '© 2024 Mini POS. All rights reserved.',
    licenseText:
  ...
  analytics: {
    ...
    // Payment Analytics
    paymentMethodsAnalytics: 'Payment Methods Analytics',
    paymentBreakdown: 'Payment Method Breakdown',
    totalRevenue: 'Total Revenue',
    noPaymentData: 'No payment data available',
    loadingPaymentAnalytics: 'Loading payment analytics...',
    // Short month names
    jan: 'Jan',
    feb: 'Feb',
    mar: 'Mar',
