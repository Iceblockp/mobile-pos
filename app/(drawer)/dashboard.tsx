...
/**
 * Dashboard page for drawer navigation
 *
 * Features:
 * - Displays key business metrics and analytics
 * - Shows daily sales and expenses charts
 * - Lists top performing products
 * - Provides store overview with low stock alerts
 * - Includes MenuButton for sidebar navigation
 *
 * Requirements:
 * - 1.1: Dashboard is the default page in drawer navigation
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/(drawer)/overview')}
          >
      ...
      >
              ...
              <View style={styles.metricText}>
                ...
                {lowStockCount > 0 && (
                  <TouchableOpacity
                    ...
                    onPress={() => router.push('/(drawer)/low-stock')}
                  >
        ...
        <Card style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/(drawer)/overview')}>
        ...
        <Card style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity
              onPress={() => router.push('/(drawer)/product-management')}
            >
              <Text style={styles.viewAllText} weight="medium">
                {t('dashboard.manage')}
              </Text>
