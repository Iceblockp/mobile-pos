...
class MigrationValidationChecker {
  ...
  async checkUUIDMigrationServiceEnhanced() {
    try {
  ...
  async checkValidationInterfaces() {
    try {
      const filePath = path.join(
        process.cwd(),
        'services/uuidMigrationService.ts'
  ...
  async checkUUIDFormatValidation() {
    try {
      const filePath = path.join(
        process.cwd(),
        'services/uuidMigrationService.ts'
  ...
  async checkForeignKeyValidation() {
    try {
      const filePath = path.join(
        process.cwd(),
        'services/uuidMigrationService.ts'
  ...
  async checkDataIntegrityValidation() {
    try {
      const filePath = path.join(
        process.cwd(),
        'services/uuidMigrationService.ts'
...
async function main() {
  ...
  const success = await checker.runValidation();
...
module.exports = { MigrationValidationChecker };
